...
class MaskDetectionViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func setupTabBar() {
        ...
        self.navigationItem.title = "Mask Detection"
    ...
    func setUpModel() {
        if let visionModel = try? VNCoreMLModel(for: maskdetect_1().model) {
...
extension MaskDetectionViewController: VideoCaptureDelegate {
...
extension MaskDetectionViewController {
